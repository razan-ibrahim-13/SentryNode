        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="flex items-baseline space-x-8">
              <a
                href="#home"
                className="group relative text-white hover:text-brand-bronze px-3 py-2 text-sm font-light tracking-wide transition-colors"
              >
                Home
          ...
          <div className="hidden md:block">
            <div className="flex items-baseline space-x-8">
              ...
              <a
                href="#contact"
                className="group relative text-white hover:text-brand-bronze px-3 py-2 text-sm font-light tracking-wide italic transition-colors"
              >
                Inquire
                <span className="absolute bottom-0 left-0 h-0.5 bg-brand-bronze w-0 group-hover:w-full transition-all duration-300 ease-out"></span>
              </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-brand-darkestGreen/95">
              ...
              <a
                href="#contact"
                className="text-brand-bronze/70 hover:text-brand-bronze block px-3 py-2 text-sm font-light tracking-wide italic"
              >
                Inquire
              </a>
            </div>
